			  <div class="card">
			      <div class="card-header">
			          <h4><small><a href="index.php?hal=tambah_data_pelajaran" class="btn btn-primary"><i
			      ...
			      <div class="card-body">
					  ...
					  ?>
			                      <tr>
			                          ...
			                          <td>
			                              <center>
			                                  <a href="index.php?hal=edit_pelajaran&edit=<?php echo $da ['id_pelajaran'];?>"
			                                      class="label label-primary">Edit</a>
			                                  <a href="hapus.php?data=pelajaran&id=<?=$da['id_pelajaran'];?>"
