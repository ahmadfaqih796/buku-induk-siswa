			  <div class="card">
			      <div class="card-header">
			          <h4><small><a href="index.php?hal=tambah_data_kelas" class="btn btn-primary"><i
			                          class="fa fa-plus"></i></a></small> <?=getAddress();?></h4>
			      </div>
			      <div class="card-body">
					  ...
					  ?>
			                      <tr>
			                          ...
			                          <td><?=$da['ruang'];?></td>
			                          <td>
			                              <a href="index.php?hal=info_kelas&idk=<?php echo $da ['id_kelas'];?>"
			                                  class="label label-success">Info</a>
			                              <a href="index.php?hal=edit_kelas&edit=<?php echo $da ['id_kelas'];?>"
			                                  class="label label-primary">Edit</a>
			                              <a href="hapus.php?data=kelas&id=<?=$da['id_kelas'];?>" class="label label-warning"
